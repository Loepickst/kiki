(function (window) {
    ...
    const fortunes = [
        ...
        { id: "f48", rarity: "KR", title: "忍吉", desc: "吃得痛中痛，方为狗上狗，这老肩啊！～", weight: 3, color: "#000000", icon: "takarakuji/renji.webp?v=20260720-renji1", foilVariant: { icon: "takarakuji/foil_renji.webp?v=20260720-renji-foil1" } },
        ...
        { id: "f9", rarity: "SSR", title: "猫吉", desc: "明确内心，不被外界所迷惑，直取自己的“目标”，走最优雅的“猫步”。", weight: 5, color: "#ec407a", icon: `${EX_CARD_ASSET_BASE}maoji2.png`, hiddenStage2: { unlockCount: 20, icon: "takarakuji/stage2_maoji.webp" }, foilVariant: { icon: "takarakuji/foil_maoji.webp?v=20260717-redesign1" } },
        { id: "f12", rarity: "SSR", title: "鸽吉", desc: "咕咕咕，咕咕咕咕咕咕咕，咕咕？咕！", weight: 3, color: "#d32f2f", icon: `${EX_CARD_ASSET_BASE}geji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_geji.png" }, foilVariant: { icon: "takarakuji/foil_geji.webp?v=20260717-redesign2" } },
        ...
        { id: "f3", rarity: "SR", title: "猴吉", desc: "做不了真“大圣”，也能拥有“大圣”心，先得敢想，才能真成！", weight: 10, color: "#388e3c", icon: `${EX_CARD_ASSET_BASE}houji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_houji.png" }, foilVariant: { icon: "takarakuji/foil_houji.webp?v=20260717-redesign2" } },
        ...
        { id: "f6", rarity: "SR", title: "熊吉", desc: "学饿了就吃点，吃饱了就休息，那学习呢？学习就明天再说吧。", weight: 10, color: "#7b1fa2", icon: `${EX_CARD_ASSET_BASE}xiongji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_xiongji.webp" }, foilVariant: { icon: "takarakuji/foil_xiongji.webp?v=20260717-redesign1" } },
        { id: "f14", rarity: "SR", title: "燕吉", desc: "每天只衔一个词，日积月累，也能筑起坚不可摧的语言之巢。", weight: 10, color: "#7b1fa2", icon: `${EX_CARD_ASSET_BASE}yanji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_yanji.webp" }, foilVariant: { icon: "takarakuji/foil_yanji.webp?v=20260717-redesign1" } },
        { id: "f17", rarity: "SR", title: "牛吉", desc: "纵使当下如对牛弹琴般不得要领，耐下性子温故知新，笨功夫自有回响。", weight: 10, color: "#546e7a", icon: `${EX_CARD_ASSET_BASE}niuji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_niuji.png" }, foilVariant: { icon: "takarakuji/foil_niuji.webp?v=20260717-redesign2" } },
        ...
        { id: "f5", rarity: "R", title: "犬吉", desc: "温故而知新。比起新内容，今天更适合把之前的错题翻出来‘叙叙旧’哦！", weight: 30, color: "#f57c00", icon: `${EX_CARD_ASSET_BASE}quanji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_quanji.png" }, foilVariant: { icon: "takarakuji/foil_quanji.webp?v=20260717-redesign1" } },
        { id: "f4", rarity: "R", title: "鼠吉", desc: "一点一滴地搬运，终能囤满语言的粮仓。", weight: 30, color: "#1976d2", icon: `${EX_CARD_ASSET_BASE}shuji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_shuji.png" }, foilVariant: { icon: "takarakuji/foil_shuji.webp?v=20260717-redesign1" } },
        { id: "f11", rarity: "R", title: "狐吉", desc: "🍵普普通通、平平淡淡的一天。按部就班地背单词吧，没有波澜也是一种幸福。", weight: 30, color: "#8d6e63", icon: `${EX_CARD_ASSET_BASE}pingji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_huji.png" }, foilVariant: { icon: "takarakuji/foil_huji.webp?v=20260717-redesign1" } },
        { id: "f15", rarity: "R", title: "龟吉", desc: "要想“快”，先得“慢”，只有学会了放平心态去细细打磨，“快”便会自然出现。", weight: 30, color: "#8d6e63", icon: `${EX_CARD_ASSET_BASE}guiji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_guiji.png" }, foilVariant: { icon: "takarakuji/foil_guiji.webp?v=20260720-rabbit-turtle-fix1" } },
        { id: "f18", rarity: "R", title: "鼬吉", desc: "思维若如鼬般柔软，再凶狠的学习障碍，也能轻盈越过。", weight: 30, color: "#8d6e63", icon: `${EX_CARD_ASSET_BASE}youji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_youji.png" }, foilVariant: { icon: "takarakuji/foil_youji.webp?v=20260717-redesign2" } },
        { id: "f31", rarity: "R", title: "鬼吉", desc: "好意的显现，不一定是笑容，有时候也可能会是某种“恐怖😱”哦", weight: 30, color: "#8d6e63", icon: `${EX_CARD_ASSET_BASE}eji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_eji.png" }, foilVariant: { icon: "takarakuji/foil_eji.webp?v=20260717-redesign2" } },
        { id: "f25", rarity: "R", title: "鵺吉", desc: "困难，即是机遇，不要畏惧不要害怕，解题之法就在其中！", weight: 30, color: "#8d6e63", icon: `${EX_CARD_ASSET_BASE}nueji.png`, themeSetId: "hyakki_yakou", hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_nueji.png" }, foilVariant: { icon: "takarakuji/foil_nueji.webp?v=20260720-redesign3" } },
        ...
        { id: "f39", rarity: "R", title: "鹰吉", desc: "日复一日的练习，必然让你练就锐利的“鹰眼”，一箭正中要害！", weight: 30, color: "#5C4A3D", icon: `${EX_CARD_ASSET_BASE}yingji.png`, hiddenStage2: { unlockCount: 10, icon: "takarakuji/stage2_yingji.png" }, foilVariant: { icon: "takarakuji/foil_yingji.webp?v=20260717-redesign2" } }
