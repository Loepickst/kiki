(function (window) {
    ...
    const fortunes = [
        ...
        { id: "f24", rarity: "SR", title: "兔吉", desc: "兔起鹘落般的进步，恰恰蕴藏在从一到十、踏踏实实的研磨之中。", weight: 10, color: "#00897b", icon: `${EX_CARD_ASSET_BASE}tuji.png`, foilVariant: { icon: "takarakuji/foil_tuji.webp?v=20260717-redesign2" } },
